...
async function main() {
  ...
  const reseauContact1 = await prisma.client.create({
    data: {
      ...
      horizonActivation: "lancement", prochaineActionReseau: "Inviter dejeuner reseau",
  ...
  const reseauContact2 = await prisma.client.create({
    data: {
      ...
      horizonActivation: "deuxieme_phase", prochaineActionReseau: "Presentation offre dirigeants",
  ...
  const reseauContact3 = await prisma.client.create({
    data: {
      ...
      horizonActivation: "deuxieme_phase", prochaineActionReseau: "Envoyer plaquette cabinet",
